...
## [NEEDS_VALIDATION] frac_rate 게이트(-5.5m/s CAUTION 문턱)가 실측
대비 과도하게 보수적일 가능성 — 세그7/세그12 no-decel 실측 재검토
(2026-08-21, 27차, 관련: 26차 `frac_rate` 게이트 설계, 로컬 커밋
`5cc0900`, 아직 origin 미push)
